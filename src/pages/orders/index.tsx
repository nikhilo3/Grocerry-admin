    ...
    return (
        <div className="flex flex-col gap-11 overflow-hidden font-inter">
                ...
                <div className="border border-accent-200 rounded-[20px] bg-white p-6 flex flex-col gap-6 min-w-[1100px]">
                    <div className="gap-6 items-center flex">
                        ...
                        <Dropdown
                            ...
                            setDropdownItems={(items: any[]) => setSelectedStatus(items[0] || '')}
                        />
                    ...
                    <div className="grid grid-cols-6 gap-[0px] p-4 bg-gray-500 text-accent-50 rounded-xl font-inter">
                        ...
                        <div className="flex items-center justify-center">Customer Name</div>
                        ...
                        {filteredData.length > 0 ? (
                            filteredData.map((order, index) => {
                                ...
                                return (
                                    <div
                                        key={index}
                                        className={`grid grid-cols-6 gap-6 p-4 font-inter ${index % 2 === 0 ? 'bg-gray-50' : 'bg-white'
                                            } rounded-xl relative`}
                                    >
                                        <div className="flex items-center gap-6">
                                            <UnCheckedBox className="w-[18px] h-[18px]" />
                            ...
                            <div className="flex justify-center items-center h-24 text-gray-500">No data found</div>
                        )}
                    </div>
                </div>
            </div>
            ...
            {isOutForDeliveryModalOpen && (
                <dialog open className="bg-white rounded-xl p-6 shadow-xl inset-0 fixed">
                    <div className="flex justify-between">
                        <div>
                            <h2 className="text-[28px] font-bold">Assign a Driver</h2>
                            <p className="text-[14px] leading-0 text-accent-600 ">The order has been marked as Out-for-Delivery.</p>
                    ...
                    <div className={`flex justify-center gap-2 py-2 my-1 w-[225px] bg-gray-200 rounded-xl ${selectedDriver ? 'bg-primary-500' : 'bg-gray-300'
                                }`}>
                        <button
                            onClick={() => {
                                if (selectedDriver) {
                            ...
                            className={`${selectedDriver ? 'bg-primary-500' : 'bg-gray-300'
