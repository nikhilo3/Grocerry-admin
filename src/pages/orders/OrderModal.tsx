...
const OrderModal = forwardRef((_props, ref: Ref<HTMLDialogElement>) => {
    ...
    return (
        <dialog ref={ref} className="modal">
            <div className="modal-box relative p-8" style={{ maxWidth: '900px', maxHeight: '1400px' }}>
                <form method="dialog">
                    <button className="btn btn-md btn-circle btn-ghost absolute right-4 top-4 text-[48px]">✕</button>
                </form>
                <div className="flex flex-col">
                    <div className="pb-2">
                        <h2 className="text-gray-700 text-[30px] font-semibold">Order Details</h2>
                    ...
                    <div className="flex gap-6 overflow-hidden">
                        ...
                        <div className="w-1/2 font-inter text-sm overflow-auto ">
                            ...
                            <div className="flex flex-col gap-4 relative">
                                ...
                                {activeDropdown && (
                                    ...
                                    >
                                        {ORDER_STATUS_OPTIONS.filter((status) => status !== selectedStatus).map(
                                            (status) => (
                                                <button
                                                    key={status}
                        ...
                        <div className="w-1/2">
                            ...
                            <div className="h-[180px] overflow-scroll hide-scrollbar flex flex-col gap-2">
                                ...
                                <div className="flex justify-between">
                                    <div className="flex gap-2">
                                        <img className="w-[48px] h-[48px]" src={hard} alt="product" />
                            ...
                            <div className="p-4 bg-accent-50 border-accent-300">
                                ...
                                <div className="flex justify-between py-2">
                                    <span className="text-[14px] text-accent-500">Delivery Charges</span>
                                    <span>₹33</span>
                                </div>
