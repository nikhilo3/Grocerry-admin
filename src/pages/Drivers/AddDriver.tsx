    ...
    return (
        <div>
            <dialog id="addDriverModal" className="modal">
                <form method="dialog" className="modal-box p-8 min-w-[752px] scrollbar-md">
                    <div className="flex flex-col gap-6 justify-center w-full">
                            ...
                            <div className="flex flex-col justify-center gap-[6px]">
                                ...
                                <div className="py-[18px] px-4 bg-accent-50 border-accent-100 border rounded-xl w-[331px]">
                                    <input
                                        ...
                                        type="text" className="outline-none text-[18px]  font-medium  w-full bg-accent-50" name="name" placeholder="eg., John Doe" id="fullName" />
                                </div>
                            </div>
                            <div className="flex flex-col justify-center gap-[6px]">
                        ...
                        <div className="flex  items-center  gap-[26px]">
                            ...
                            <div className="flex flex-col justify-center gap-[6px]">
                                <label className="text-accent-500 text-base font-medium" htmlFor="vehicleNo">Mobile No*</label>
                                <div className="py-[18px] px-4 bg-accent-50 border-accent-100 border rounded-xl w-[331px]">
                                    <input
                                        {...register("vehicleNo", {
                                            required: { value: true, message: "This field is required" }
